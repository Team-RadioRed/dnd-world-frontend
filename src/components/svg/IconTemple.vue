<template>
    <svg fill="currentcolor" height="52px" width="52px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve">
        <g>
            <g>
                <g>
                    <path
                        d="M256,0C114.841,0,0,114.841,0,256c0,1.547,0.031,3.086,0.059,4.627h128.713v-40.463h-16.193
				...
				c0,8.517-6.906,15.422-15.422,15.422h-16.193v40.463h128.712c0.028-1.541,0.059-3.08,0.059-4.627C512,114.841,397.159,0,256,0z" />
                    ...
                    <path
                        d="M383.229,310.787h16.193c8.516,0,15.422,6.904,15.422,15.422c0,8.517-6.906,15.422-15.422,15.422H112.578
